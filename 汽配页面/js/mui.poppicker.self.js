...
(function($, document) {
    ...
    var panelBuffer = '<div class="mui-poppicker">\
		<div class="mui-poppicker-header">\
			<div class="go_btn">\
				<img class="go_prev" id="go_prev" src="img/全部景区（全国）_03.png" alt="">\
				<img class="go_next" id="go_next" src="img/全部景区（全国）_05.png" alt="">\
			</div>\
			<div class="btn_ok">完成</div>\
			\
		</div>\
    ...
    var PopPicker = $.PopPicker = $.Class.extend({
        ...
        init: function(options) {
            ...
            self.ok = self.panel.querySelector('.btn_ok');
